...
aku = { 'Instagram':'https://instagram.com/jejak Internet',

		'Facebook':'https://facebook.com/njnk.xnxx',		'Website':'https://jejakinternet.xyz',

		'Github':'https://github.com/hadapan',

		'Email':'leosureo@gmail.com' }
